...
| `_plasmid_*_.fasta`            | `mob_recon`   | Plasmid reconstructions. Groups of contigs that were determined to be part of the same plasmid       |
...
| `.sorted.bam{.bai}`            | `bwa`         | Alignment of reads against a reference plasmid                                                       |
